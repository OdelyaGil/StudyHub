...
const styles = StyleSheet.create({
  ...
  passwordInput: { flex: 1, paddingHorizontal: 18, paddingVertical: 14, fontSize: 15, color: '#333' },
  ...
  regLabel:        { fontSize: 13, fontWeight: '600', color: '#333', marginBottom: 6 },
  regInput: {
    borderWidth: 1, borderColor: '#e0e0e0', borderRadius: 10,
    paddingHorizontal: 15, paddingVertical: 12,
    fontSize: 14, backgroundColor: '#f5f5f5', marginBottom: 16, color: '#333',
  },
