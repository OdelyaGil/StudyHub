...
const styles = StyleSheet.create({
  ...
  actionBtnActive: { backgroundColor: '#FFF3E0', borderRadius: 8 },
  separator:       { height: 0 },
  ...
  infoBox:        { backgroundColor: '#FFF3E0', borderRightWidth: 4, borderRightColor: '#FF8C42', borderRadius: 8, padding: 12, marginBottom: 20, flexDirection: 'row', gap: 10, alignItems: 'flex-start' },
  infoText:       { fontSize: 12, color: '#FF8C42', flex: 1, lineHeight: 18, textAlign: 'right' },
