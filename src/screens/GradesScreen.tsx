...
const styles = StyleSheet.create({
  ...
  yearAvgBadge: { backgroundColor: '#FF8C42', borderRadius: 10, paddingHorizontal: 10, paddingVertical: 4 },
  ...
  criterionTag:      { fontSize: 10, color: '#FF8C42', backgroundColor: '#FFF3E0', borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2 },
  gradeRight:        { alignItems: 'flex-end' },
  gradeValue:        { fontSize: 26, fontWeight: '700', color: '#FF8C42', marginBottom: 4 },
  ...
  fab: {
    ...
    backgroundColor: '#FF8C42', justifyContent: 'center', alignItems: 'center',
    shadowColor: '#FF8C42', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.3, shadowRadius: 8, elevation: 5,
  },
  ...
  chipActive:     { borderColor: '#FF8C42', backgroundColor: '#FFF3E0' },
  ...
  pctBadge:        { fontSize: 12, fontWeight: '700', color: '#FF8C42', backgroundColor: '#FFF3E0', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 10 },
  ...
  criterionGradeInput: { width: 60, borderWidth: 1, borderColor: '#e0e0e0', borderRadius: 8, paddingHorizontal: 8, paddingVertical: 6, fontSize: 16, textAlign: 'center', backgroundColor: '#fff' },
  addCritBtn:      { flexDirection: 'row', alignItems: 'center', gap: 6, paddingVertical: 10, paddingHorizontal: 14, borderRadius: 10, borderWidth: 1.5, borderColor: '#FF8C42' },
  addCritText:     { fontSize: 13, color: '#FF8C42', fontWeight: '600' },
  critFormBox:     { backgroundColor: '#f9f9f9', borderRadius: 12, padding: 14, marginTop: 4 },
  critInput:       { borderWidth: 1, borderColor: '#e0e0e0', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 16, backgroundColor: '#fff', marginBottom: 10, color: '#333', textAlign: 'right' },
  ...
  critAddBtn:      { flex: 1, paddingVertical: 10, borderRadius: 8, backgroundColor: '#FF8C42', alignItems: 'center' },
  critAddText:     { fontSize: 13, color: '#fff', fontWeight: '700' },
  autoGradeBox:    { backgroundColor: '#FFF3E0', borderRadius: 10, padding: 14, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 18 },
  autoGradeLabel:  { fontSize: 13, color: '#FF8C42' },
  autoGradeValue:  { fontSize: 22, fontWeight: '700', color: '#FF8C42' },
  submitBtn:       { backgroundColor: '#FF8C42', paddingVertical: 14, borderRadius: 10, alignItems: 'center', marginTop: 4, marginBottom: 24 },
