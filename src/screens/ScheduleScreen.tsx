...
const ScheduleScreen = () => {
  ...
  const renderEventItem = (ev: CalendarEvent) => {
    ...
    return (
      <View key={ev.id} style={[styles.eventItem, { borderRightColor: ev.color, borderRightWidth: 4, borderTopWidth: 1, borderBottomWidth: 1, borderLeftWidth: 1, borderTopColor: borderClr, borderBottomColor: borderClr, borderLeftColor: borderClr, backgroundColor: surface }, darkShadow as any]}>
...
const styles = StyleSheet.create({
  ...
  navBar:    { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, height: CAL_TOP_H + 8, marginHorizontal: 16, marginBottom: 8, borderRadius: 16, shadowColor: '#3D1568', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 2 },
  navTitle:  { fontSize: 15, fontWeight: '700', flex: 1, textAlign: 'center' },

  // Month calendar
  calBlock:     { marginHorizontal: 16, borderRadius: 20, marginBottom: 10, shadowColor: '#3D1568', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.13, shadowRadius: 22, elevation: 8, overflow: 'hidden', ...Platform.select({ web: { boxShadow: '6px 6px 20px rgba(61,21,104,0.12), -3px -3px 12px rgba(255,255,255,0.88)' } as any, default: {} }) },
  ...
  eventItem:    { flexDirection: 'row', alignItems: 'center', borderRadius: 20, marginBottom: 10, borderRightWidth: 4, shadowColor: '#3D1568', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.11, shadowRadius: 18, elevation: 6, overflow: 'hidden', ...Platform.select({ web: { boxShadow: '6px 6px 20px rgba(61,21,104,0.11), -3px -3px 12px rgba(255,255,255,0.88)' } as any, default: {} }) },
  ...
  // Week view
  weekDayHeader:  { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 16, paddingVertical: 12, marginHorizontal: 16, marginBottom: 6, borderRadius: 14, shadowColor: '#3D1568', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.07, shadowRadius: 8, elevation: 2 },
  ...
  miniMonth:      { width: '47%', borderRadius: 20, borderWidth: 0, padding: 12, shadowColor: '#3D1568', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.10, shadowRadius: 12, elevation: 4 },
